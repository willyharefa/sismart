...
@section('content')
    <div class="wrapper-container">
        ...
        <legend class="mb-5">Hot Prospect Page</legend>
                    ...
                    <tbody>
                        @foreach ($tickets as $key => $ticket)
                            <tr>
                                ...
                                <td>Done</td>
                                <td>
                                    <a href="{{ route('hot-prospect.show', $ticket) }}" class="btn btn-sm btn-info" onclick="return confirm('Are you sure download this file?')"><i class='bx bxs-printer'></i></a>
                                </td>
                                @endif
                            </tr>
                        @endforeach
